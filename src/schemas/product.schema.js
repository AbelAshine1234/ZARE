...
// Schema for vendor owners updating their products (vendor_id not required)
const vendorProductUpdateSchema = Joi.object({
  name: Joi.string()
    .trim()
    .min(1)
    .max(255)
  ...
  // vendor_id is NOT required for vendor owners - determined by validateProductOwnership middleware
